...
function wpex_cac_has_scrolltop() {
	return get_theme_mod( 'scroll_top', true ) ? true : false;
}
...
function wpex_cac_supports_page_header_background_img_style() {
	return ( get_theme_mod( 'page_header_background_img' ) && 'hidden' != get_theme_mod( 'page_header_style' ) ) ? true : false;
}
...
function wpex_cac_has_menu_search_dropdown() {
	return ( 'six' == get_theme_mod( 'header_style' ) || 'drop_down' != get_theme_mod( 'menu_search_style' ) ) ? false : true;
}
