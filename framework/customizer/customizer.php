...
if ( ! class_exists( 'WPEX_Customizer' ) ) {
	...
	class WPEX_Customizer {
		...
		private $is_customize_preview = false;
		private $enable_postMessage   = true;    // Disable for testing purposes
		private $inline_css_settings  = array();
		private $control_visibility   = array();
