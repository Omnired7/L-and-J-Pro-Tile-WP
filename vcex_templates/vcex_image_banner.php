...
extract( vc_map_get_attributes( 'vcex_image_banner', $atts ) );
	...
	$output .= '<div class="vcex-ib-content-wrap clr"' . $wrap_style . '>';
		...
		$output .= '<div class="vcex-ib-content clr"' . $inner_style . '>';
			...
			if ( $heading ) {
				...
				$output .= '<' . $heading_tag . ' ' . $attrs . '>' . wp_kses_post( $heading ) . '</' . $heading_tag . '>';
			}
			...
			if ( $caption ) {
				...
				$output .= '<div ' . wpex_parse_attrs( $attrs ) . '>' . wp_kses_post( $caption ) . '</div>';
			...
			if ( $has_button ) {
				...
				$output .= '<div class="vcex-ib-button"><span ' . wpex_parse_attrs( $attrs ) . '>' . wp_kses_post( $button_text ) . '</span></div>';
